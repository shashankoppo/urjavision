import { Droplets, Shield, Home as HomeIcon, Thermometer, CheckCircle, Sun, Phone } from 'lucide-react';
import { kisanUrjaSolutions } from '../utils/data';
      ...
      <section className="section-padding bg-gray-50">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {kisanUrjaSolutions.map((solution, i) => (
